...
@section('title', 'Create New Exam - EduPortal')
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">Set up a new examination schedule</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <p class="text-sm text-gray-600 dark:text-gray-400">Fill in the exam information below. All fields marked with * are required.</p>
        </div>

        <form method="POST" action="{{ route('exams.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="exam_name" id="exam_name" value="{{ old('exam_name') }}"
                ...
                <div>
                    ...
                    <select name="exam_type" id="exam_type"
                        ...
                        <option value="1st" {{ old('exam_type') == '1st' ? 'selected' : '' }}>1st Term</option>
                        <option value="2nd" {{ old('exam_type') == '2nd' ? 'selected' : '' }}>2nd Term</option>
                        <option value="3rd" {{ old('exam_type') == '3rd' ? 'selected' : '' }}>3rd Term</option>
                        <option value="custom" {{ old('exam_type') == 'custom' ? 'selected' : '' }}>Custom</option>
                    </select>
                    @error('exam_type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
            ...
            <div class="flex items-center justify-end pt-6 border-t border-gray-200 dark:border-gray-600">
                <a href="{{ route('exams.index') }}" class="mr-4 px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200">
